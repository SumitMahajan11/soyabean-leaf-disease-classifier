...
class SoybeanDiseaseDataset(Dataset):
    def __init__(self, root_dir, transform=None, max_samples_per_class=10):
        ...
        for class_name in self.classes:
            ...
            # Limit samples per class for testing
...
def create_model(model_name, num_classes):
    ...
    if model_name.lower() == 'efficientnet':
        ...
        model = models.resnet18(pretrained=True)  # Using ResNet-18 for faster testing
...
def main():
    print("Starting Soybean Disease Classification Training Pipeline - TEST VERSION")
    print(f"Using device: {device}")
    ...
    # Create full dataset with limited samples for testing
    full_dataset = SoybeanDiseaseDataset(dataset_path, transform=transform, max_samples_per_class=10)
    ...
    # Split dataset into train, validation, test (60%, 20%, 20% for faster testing)
    ...
    # Create data loaders
    batch_size = 8 if device.type == 'cuda' else 4  # Smaller batch size for testing
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=2)
    val_loader = DataLoader(val_dataset, batch_size=batch_size, shuffle=False, num_workers=2)
    test_loader = DataLoader(test_dataset, batch_size=batch_size, shuffle=False, num_workers=2)
    
    # Define models to train (using fewer epochs for testing)
    models_to_train = ["EfficientNet", "ResNet"]  # Only test 2 models for faster testing
