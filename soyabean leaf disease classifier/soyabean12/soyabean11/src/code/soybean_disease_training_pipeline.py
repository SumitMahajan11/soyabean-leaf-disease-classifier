...
def main():
    print("Starting Soybean Disease Classification Training Pipeline")
    print(f"Using device: {device}")
    ...
    # Create data loaders
    batch_size = 8 if device.type == 'cuda' else 4  # Reduced batch size to manage memory
    ...
    for model_name in models_to_train:
        ...
        trained_model, best_acc = train_model(
            ...
            num_epochs=40,  # Configurable epoch count
            model_name=model_name,
