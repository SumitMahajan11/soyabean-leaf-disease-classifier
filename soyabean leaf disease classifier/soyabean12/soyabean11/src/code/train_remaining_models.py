...
def train_model(model, train_loader, val_loader, num_epochs=20, model_name="model", save_dir="CNN_trained_models"):
...
def main():
    print("Starting training for remaining models: MobileNet and DenseNet")
    print(f"Using device: {device}")
    ...
    for model_name in models_to_train:
        ...
        trained_model, best_acc = train_model(
            ...
            num_epochs=20,  # Reduced epochs for memory management
            model_name=model_name,
