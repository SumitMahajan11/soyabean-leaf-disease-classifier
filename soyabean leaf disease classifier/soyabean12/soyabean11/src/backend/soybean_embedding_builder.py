...
This script should be run once (or occasionally) to build a reference bank of
soybean embeddings using the production Enhanced EfficientNet-B3 model.

Usage sketch (to run manually from command line):

    python -m soybean_embedding_builder \
        --images_dir e:/soyabean11/assets/data/final_dataset/soybean_only \
        --output_path e:/soyabean11/models/CNN_trained_models/soybean_embedding_bank.npy

You can adjust --images_dir to point to a folder containing only soybean
training images used for the classifier.
"""
